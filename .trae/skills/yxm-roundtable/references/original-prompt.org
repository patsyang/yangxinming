#+title:      圆桌讨论原始框架参考
#+filetags:   :roundtable:reference:
#+identifier: pat-roundtable-original-prompt

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
;; 用途: pat-roundtable 的原始框架参考资料
;; 维护者: Pat
;; 说明: 本文件只用于理解圆桌讨论的设计意图，不作为运行时输出模板。
;;       实际执行规则、时间戳生成方式和写入路径以 ../SKILL.md 为准。
;; 框架意图: 构建一个以"求真"为目标的结构化对话框架。该框架由一位极具洞察力的主持人
