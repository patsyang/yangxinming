...
```bash
python .trae/skills/yxm-ui-ux-pro-max/scripts/search.py "<product_type> <industry> <keywords>" --design-system [-p "Project Name"]
```
...
**Example:**
```bash
python .trae/skills/yxm-ui-ux-pro-max/scripts/search.py "beauty spa wellness service" --design-system -p "Serenity Spa"
```
...
```bash
python .trae/skills/yxm-ui-ux-pro-max/scripts/search.py "<query>" --design-system --persist -p "Project Name"
```
...
```bash
python .trae/skills/yxm-ui-ux-pro-max/scripts/search.py "<query>" --design-system --persist -p "Project Name" --page "dashboard"
```
...
```bash
python .trae/skills/yxm-ui-ux-pro-max/scripts/search.py "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
python .trae/skills/yxm-ui-ux-pro-max/scripts/search.py "<keyword>" --stack <your-stack>
...
```bash
python .trae/skills/yxm-ui-ux-pro-max/scripts/search.py "AI search tool modern minimal" --design-system -p "AI Search"
```
...
python .trae/skills/yxm-ui-ux-pro-max/scripts/search.py "minimalism dark mode" --domain style

# Get UX best practices for search interaction and loading
python .trae/skills/yxm-ui-ux-pro-max/scripts/search.py "search loading animation" --domain ux
```

### Step 4: Stack Guidelines

```bash
python .trae/skills/yxm-ui-ux-pro-max/scripts/search.py "list performance navigation" --stack nextjs
```
...
python .trae/skills/yxm-ui-ux-pro-max/scripts/search.py "fintech crypto" --design-system

# Markdown - best for documentation
python .trae/skills/yxm-ui-ux-pro-max/scripts/search.py "fintech crypto" --design-system -f markdown
```
